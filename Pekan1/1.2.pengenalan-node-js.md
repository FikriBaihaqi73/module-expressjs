...
Kemudian pada file `index.js` kita bisa gunakan keyword `import` untuk menggunakan module ini:

```javascript
import http from 'http';
import { hello } from './helloWorld.js'; // Menggunakan module lokal

const requestListener = (req, res) => {
  res.statusCode = 200;
  res.setHeader('Content-Type', 'text/plain');
  res.write(hello()); // Menggunakan fungsi dari module helloWorld
  res.end();
};
...
```javascript
import http from 'http';
import moment from 'moment'; // Menggunakan module moment
